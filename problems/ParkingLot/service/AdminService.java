...
import problems.ParkingLot.repository.FloorRepository;
...
public class AdminService {
    ...
    public void initializeParkingLot() {
        ...
        addSlotsToFloor(0, VehicleType.BIKE, 20);
        addSlotsToFloor(0, VehicleType.CAR, 30);
        addSlotsToFloor(0, VehicleType.TRUCK, 5);

        // Add slots to floor 1
        addSlotsToFloor(1, VehicleType.CAR, 40);
        addSlotsToFloor(1, VehicleType.EV, 10);

        // Add slots to floor 2
        addSlotsToFloor(2, VehicleType.CAR, 35);
        addSlotsToFloor(2, VehicleType.EV, 15);
    ...
    private void addSlotsToFloor(int floorNumber, VehicleType slotType, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ParkingSlot slot = new ParkingSlot(slotType, floorNumber, i*10);
    ...
    private void initializeDefaultPricingRules() {
        ...
        PricingRule evRule = new PricingRule(VehicleType.EV, 15.0, 45.0);
    ...
    public void addSlotsToFloorPublic(int floorNumber, VehicleType slotType, int count) {
    ...
    public void updateFlatPricing(VehicleType vehicleType, double flatRate) {
    ...
    public void updateHourlyPricing(VehicleType vehicleType, double ratePerHour) {
    ...
    public Map<String, Object> getParkingStatus() {
        ...
        Map<VehicleType, Long> slotStats = slotRepository.getSlotStatistics();
