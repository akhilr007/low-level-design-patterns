package problems.ParkingLot.main;

import problems.ParkingLot.controller.AdminController;
import problems.ParkingLot.controller.EntryController;
import problems.ParkingLot.controller.ExitController;
import problems.ParkingLot.entity.PricingRule;
import problems.ParkingLot.entity.enums.VehicleType;
import problems.ParkingLot.repository.*;
...
public class ParkingLotSimulation {
    ...
    public static void main(String[] args) {
        ...
        PricingService pricingService = new PricingService(pricingRuleRepository, vehicleRepository);
        ...
        EntryController entryController = new EntryController(ticketService, slotService, vehicleService);
    ...
    private static void simulateVehicleEntry(EntryController entryController,
                                             String licensePlate,
    ...
    private static void simulateAdminOperations(AdminController adminController) {
        ...
        adminController.addSlotsToFloor(3, VehicleType.EV, 5);

        // Update pricing for CAR
        adminController.updatePricingRule(VehicleType.CAR, 25.0, 60.0);

        // Update flat pricing for BIKE
        adminController.updateFlatPricing(VehicleType.BIKE, 35.0);

        // Update hourly pricing for TRUCK
        adminController.updateHourlyPricing(VehicleType.TRUCK, 40.0);

        // Add a new pricing rule for EV
        PricingRule newEvRule = new PricingRule(VehicleType.EV, 18.0, 50.0);
